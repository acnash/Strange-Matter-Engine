...
The ridge readout learns coefficients (eta). Backpropagation carries the prediction error further backwards through (z_m) and through all (T) CA generations to learn (	heta).
