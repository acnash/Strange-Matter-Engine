...
The current candidate is **Cross-Validated CYP-Specialist Graph Cellular Automata (CV-CYP-GCA v1)**. Four independent nonlinear systems specialise the cellular dynamics for CYP1A2, CYP2C9, CYP2D6, and CYP3A4. All ten transition rules were screened for every endpoint, followed by five-fold, two-seed confirmation and sparse rule selection. CYP1A2 selected conservative graph flux, delayed memory, and Gray-Scott; CYP2C9 selected damped symplectic and activator-inhibitor; CYP2D6 selected delayed memory and FitzHugh-Nagumo; CYP3A4 selected Gray-Scott, damped symplectic, and coupled map.
...
On the sealed validation set, CV-CYP-GCA achieved point MA-ST-RAE **0.7690**, bootstrap mean **0.7697** with a 95% interval of **0.7320 to 0.8127**, and RMSE **0.8625 pIC50**. Its macro MAE was 0.6296, R-squared 0.2694, Spearman rho 0.5218, and Kendall tau 0.3715. The preceding CFT-DS-GCAE candidate achieved point MA-ST-RAE 0.7739 and RMSE 0.8586.

The first DS-GCAE blind submission ranked 80th of 89 with MA-ST-RAE 1.0132. The second CFT-DS-GCAE submission ranked 82nd of 90 with MA-ST-RAE 1.0120. These organiser results remain the external benchmarks for the new CV-CYP-GCA submission.
