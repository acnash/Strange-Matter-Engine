...
The canonical production and submission model is **EA-CV-CYP-GCA v1**, the Endpoint-Aligned Cross-Validated CYP-Specialist Graph Cellular Automata system. It achieved sealed point MA-ST-RAE **0.754503**, bootstrap mean **0.755073** with a 95% interval of **0.717656 to 0.797014**, and RMSE **0.852280 pIC50** on the fixed sealed scaffold holdout.

Its official blind evaluation returned MA-ST-RAE **1.0071**, macro MAE **1.0778**, macro R-squared **-0.0715**, macro Spearman rho **0.5345**, and macro Kendall tau **0.3750**. This is the strongest official primary result recorded for the project and is the basis for fixing EA-CV-CYP-GCA as the production method.

EA-CV-CYP-GCA uses chemically encoded atoms as cells, typed bonded interactions, explicit recurrent generations, retained trajectory features, backpropagation, and a genuine differentiable ridge readout. The [permanent method report](METHOD_REPORT.md) provides the complete configuration, validation protocol, official result, and submission schema.
