...
On the final validation set, CFTC-GCAE achieved point MA-ST-RAE **0.7739**, bootstrap mean **0.7749** with a 95% interval of **0.7356 to 0.8193**, and RMSE **0.8586 pIC50**. DS-GCAE achieved 0.7842 and 0.8678 respectively. The improvement is modest and the uncertainty intervals overlap.

The first DS-GCAE blind submission ranked 80th of 89, with leaderboard MA-ST-RAE 1.0132, MA 1.0893, macro R-squared -0.0827, macro Spearman rho 0.4751, and macro Kendall tau 0.3323. This generalisation gap motivated the cross-fitted target-specific stack. Frozen inference produced 3,000 finite CFTC-GCAE predictions for the 750 blinded molecules without loading test labels. The new challenge-ready file is [`results/production_cross_fitted_target_calibrated_gcae_v1/cftc_gcae_submission.csv`](results/production_cross_fitted_target_calibrated_gcae_v1/cftc_gcae_submission.csv).
