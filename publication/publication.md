...
**Figure 3. Molecular information cascades generated by the four Graph-CA trajectories in Figure 1.** Each panel shows the complete retained cascade at generation 5,000. At every sampled generation, the molecule was rotated slightly and displaced downwards while all earlier atom positions were retained. Atom colour combines cellular-automata time with the contemporaneous mean state across the 16 dynamical channels. The cascade therefore depicts learned chemical-information evolution across the bonded molecular graph rather than molecular translation through physical space. **A**, gated-residual point attractor. **B**, confirmed Kuramoto–Sakaguchi strange attractor. **C**, Kuramoto–Sakaguchi persistent or complex candidate. **D**, coupled-map period-two oscillator candidate. Bonds are omitted to reveal the accumulated atom-state structure. A vector version is available as [PDF](../results/long_horizon_attractor_campaign_v1/figures/19_four_graph_ca_terminal_atom_cascades.pdf).
