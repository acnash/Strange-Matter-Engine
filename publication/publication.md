...
![Complete convergence of a Graph-CA trajectory to a point attractor](../results/long_horizon_attractor_campaign_v1/figures/13_trajectory_01_point_attractor_convergence.png)

**Figure 2. Convergence to a point attractor.** The complete atom-by-channel state of `OCNT-2328519`, conditioned on CYP1A2 under the frozen gated-residual transition rule, was projected onto three principal-component coordinates. The full-state distance from the terminal state decreased from 8.00 at initialization to 0.00465 by generation 100 and remained close to the terminal point through generation 5,000. The first three coordinates captured 99.8% of the variance during the first 500 generations. This contracting orbit provides a direct visual comparison with the bounded, continually expanding trajectory in Figure 1. A [30-second cyberpunk animation](../results/long_horizon_attractor_campaign_v1/videos/trajectory_01_point_attractor_convergence.mp4) expands the early generations so that convergence can be followed in real time.
