import gzip
import json
GCA_STATE_COUNT = 1001
GCA_HYDROGEN_CODA_STATE = None
with gzip.open(r'C:\Users\Anthony\OneDrive\Documents\ChatGPT\Strange Matter Engine\results\ds_gcae_1000_generation_pymol\display_values.json.gz', 'rt', encoding='utf-8') as _handle:
